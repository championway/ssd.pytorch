...
SUBTREAL_CLASSES = [  # always index 0
    'bb_extinguisher']

# note: if you used our download scripts, this should be right
SUBTREAL_ROOT = osp.join("/media/arg_ws3/5E703E3A703E18EB", "data/subt_real_ssd")


class SUBTREALAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(SUBTREAL_CLASSES, range(len(SUBTREAL_CLASSES))))
...
class SUBTREALDetection(data.Dataset):
    ...
    def __init__(self, root,
                 ...
                 transform=None, target_transform=SUBTREALAnnotationTransform(),
