...
ARGBOT_CLASSES = [  # always index 0
    'person', 'palm']

# note: if you used our download scripts, this should be right
ARGBOT_ROOT = osp.join("/media/arg_ws3/5E703E3A703E18EB", "data/argbot")


class ARGBOTAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(ARGBOT_CLASSES, range(len(ARGBOT_CLASSES))))
...
class ARGBOTDetection(data.Dataset):
    ...
    def __init__(self, root,
                 ...
                 transform=None, target_transform=ARGBOTAnnotationTransform(),
                 dataset_name='ARGBOT'):
        self.root = root
        ...
        for name in image_sets:
            ...
            for line in open(osp.join(rootpath, 'Main', name + '.txt')):
